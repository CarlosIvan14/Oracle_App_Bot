// 4. Reporte KPI Horas trabajadas  y Tareas completadas por EQUIPO por semana/sprint
...
global.ResizeObserver = class {
  ...
  describe("Team Report with KPIs", () => {
      beforeAll(() => {
        ...
        test("displays task details when selecting sprint and team", async () => {
          ...
          expect(screen.getByLabelText('report-user')).toHaveTextContent(/todo el equipo/i);   
