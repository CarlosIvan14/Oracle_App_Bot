  ...
  function ManagerDashboard() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-700 to-gray-950 flex flex-col items-center">
        ...
        {/* Contenedor normal para el botón (sin pt-28) */}
        <div className="mt-10 flex justify-center">
          <NewItemModal addItem={addItem} isInserting={isInserting} />
        </div>
    
        {/* Contenedor con padding-top si quieres dejar un espacio para la lista */}
        <div className=" w-full max-w-4xl bg-black bg-opacity-40 backdrop-blur-md p-8 rounded-xl shadow-xl mt-8">
          ...
          {error && <p className="text-red-400 text-center mt-4">Error: {error.message}</p>}
          ...
          {isLoading ? (
            ...
            <TaskList items={items} toggleDone={toggleDone} deleteItem={deleteItem} />
          )}
        </div>
      </div>
    );
