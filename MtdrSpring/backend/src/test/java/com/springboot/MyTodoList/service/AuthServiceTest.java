...
public class AuthServiceTest {
	...
	public void testDoLoginSuccess() {
		...
		when(restTemplate.postForEntity(eq("http://140.84.174.78/api/users/login"), any(LoginRequest.class),
		...
		verify(restTemplate).postForEntity(eq("http://140.84.174.78/api/users/login"), any(LoginRequest.class),
				eq(OracleUser.class));
	}
