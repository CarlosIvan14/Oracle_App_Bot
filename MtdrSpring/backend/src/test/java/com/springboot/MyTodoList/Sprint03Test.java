...
public class Sprint03Test {
	...
	public void testCreateTask() { // TEST DEMO 01 FOR BOT.
		...
		String url = "http://140.84.179.223api/tasks";
	...
	public void testGetSprintsByProjectId() { // TEST DEMO 02 FOR BOT.
		...
		int projectId = 42;
		String expectedUrl = "http://140.84.179.223api/sprints/project/" + projectId;
	...
	public void testGetUserTaskAssignments() { // TEST DEMO 03 FOR BOT.
		...
		int sprintId = 1;
		int projectUserId = 2;
		String expectedUrl = "http://140.84.179.223api/task-assignees/user/2/sprint/1";
